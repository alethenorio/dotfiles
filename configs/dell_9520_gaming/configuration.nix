...

{
  ...
  # Enable udiskctl to be able to easily mount USB disks
  ...
  # so binaries don't have to be patched
  # See https://discourse.nixos.org/t/runtime-alternative-to-patchelf-set-interpreter/3539/5 for details
